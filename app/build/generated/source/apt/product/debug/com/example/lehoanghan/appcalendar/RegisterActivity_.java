    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        this.llRegister = ((LinearLayout) hasViews.findViewById(R.id.activity_regiter_ll_register));
        this.etName = ((EditText) hasViews.findViewById(R.id.activity_register_et_username));
        this.etMail = ((EditText) hasViews.findViewById(R.id.activity_register_et_gmail));
        this.etPass = ((EditText) hasViews.findViewById(R.id.activity_register_et_password));
        this.etConfPass = ((EditText) hasViews.findViewById(R.id.activity_register_et_confirmpassword));
        this.btnRegister = ((Button) hasViews.findViewById(R.id.activity_register_btn_register));
        this.cbRegister = ((CheckBox) hasViews.findViewById(R.id.activity_register_cb_agree_register));
        this.tvLogin = ((TextView) hasViews.findViewById(R.id.activity_register_tv_login_here));
        if (this.btnRegister!= null) {
            this.btnRegister.setOnClickListener(new OnClickListener() {

                @Override
                public void onClick(View view) {
                    RegisterActivity_.this.setBtnRegister();
                }
            }
            );
        }
        if (this.tvLogin!= null) {
            this.tvLogin.setOnClickListener(new OnClickListener() {
                ...
                @Override
                public void onClick(View view) {
                    RegisterActivity_.this.setTvLogin();
                }
            }
            );
        }
