...
public class AccountFragment extends Fragment {
    ...
    public View onCreateView(
        ...
        contentView = layoutInflater.inflate(R.layout.fragment_account, container, false);
    ...
    public void aInit() {
        tvName = (TextView) contentView.findViewById(R.id.fragment_account_tv_name_value);
        tvMail = (TextView) contentView.findViewById(R.id.fragment_account_tv_mail_value);
        ivAvatar = (ImageView) contentView.findViewById(R.id.fragment_account_iv_avatar);
        btnChageInfo = (Button) contentView.findViewById(R.id.fragment_account_btn_change);
    }
